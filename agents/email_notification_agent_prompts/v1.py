system_prompt = """
    ...
    4. Make them personal, actionable, and urgency-driven
    ...
    7. Include compelling numbers, rates, or savings amounts
    8. Use power words like "Unlock", "Exclusive", "Save", "Earn", "Limited"
