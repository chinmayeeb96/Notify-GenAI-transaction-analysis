...
df = pd.read_csv("data/data_generation/transaction_data/transaction_data_finalpart2_updated.csv")
...
for userid in user_ids:
    # filter dataframe for each user
    user_df = df[df["User Id"] == userid].copy()
...
new_df.to_csv("data/data_generation/transaction_data/transaction_data_finalpart2_updated_txnid.csv", index=False)
